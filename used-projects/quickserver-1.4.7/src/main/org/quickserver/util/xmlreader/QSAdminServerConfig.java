	...
	public String toXML(String pad) {
		...
		*/
		...
		if(getCommandPlugin()!=null) 
			sb.append(pad+"\t<command-plugin>"+getCommandPlugin()+"</command-plugin>\n");
		
		sb.append(pad+"\t<command-shell>\n");
		sb.append(pad+"\t\t<enable>"+getCommandShellEnable()+"</enable>\n");
		sb.append(pad+"\t\t<prompt-name>"+getCommandShellPromptName()+"</prompt-name>\n");
		sb.append(pad+"\t</command-shell>\n");
