...
public class LambdaAndAnonymousTest {
    ...
    public void m1Test() {
        assertThat(result, hasItems(
            Call.of("ifpb.gpes.domain.SampleObject", "test[]", "void", "ifpb.gpes.domain.LambdaAndAnonymous", "testOther[]", "void", null, "this.d"),
            Call.of("ifpb.gpes.domain.Interface", "noReturn[]", "void", "ifpb.gpes.domain.LambdaAndAnonymous", "m3[]", "void", null, "i"),
            Call.of("java.util.List", "iterator[]", "java.util.Iterator<ifpb.gpes.domain.HasJCFObject>", "ifpb.gpes.domain.Interface", "noReturn[]", "void", null, "new HasJCFObject().getElements()"),
            Call.of("ifpb.gpes.domain.HasJCFObject", "getElements[]", "java.util.List<ifpb.gpes.domain.HasJCFObject>", "ifpb.gpes.domain.Interface", "noReturn[]", "void", "iterator[]", "new HasJCFObject()"),
            ...
            Call.of("ifpb.gpes.domain.LambdaAndAnonymous", "list[java.util.List<ifpb.gpes.domain.HasJCFObject>]", "void", "ifpb.gpes.domain.LambdaAndAnonymous", "m3[]", "void", null, "this"),
            ...
            Call.of("java.util.List", "get[int]", "ifpb.gpes.domain.HasJCFObject", "ifpb.gpes.domain.LambdaAndAnonymous", "list[java.util.List<ifpb.gpes.domain.HasJCFObject>]", "void", null, "collection")
        ));
    ...
    private List<Call> ofLambdaArguments() {
        Project project = Project
            .root("")
            .path(sources + File.separator + PathUtils.connect("ifpb","gpes","domain","LambdaAndAnonymous.java"))
            .sources(sources)
            .filter(".java");
